...
def report(file_registry, args_dict, model_spec, target_html_filepath,
           ...
           raster_plot_captions: RasterPlotCaptionGroup,
    ...
    Args:
        ...
        raster_plot_captions (``RasterPlotCaptionGroup``): captions to
            to accompany input, output, and intermediate output raster plots.
